...
RUN curl -L https://repo1.maven.org/maven2/org/apache/iceberg/iceberg-flink-runtime-1.19/1.6.1/iceberg-flink-runtime-1.20-1.7.0.jar -o /opt/flink/lib/iceberg-flink-runtime-1.20-1.7.0.jar
